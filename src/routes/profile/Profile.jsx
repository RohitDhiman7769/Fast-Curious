            ...
            {confirmationModal &&
                <section className="profile__delete-modal">
                    <section className="profile__delete-window">
                        ...
                        <section>
                            <button type="button" className="profile__delete-confirm" onClick={() => deleteUser(currentUser.id)}>Confirm</button>
                            <button type="button" className="profile__delete-cancel" onClick={() => { setConfirmationModal(false); ResetLocation() }}>Cancel</button>
                        </section>
                    </section>
                </section>
            }
